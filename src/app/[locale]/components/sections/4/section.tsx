                        ...
                        <div className="flex flex-col gap-8 lg:flex-row content-center min-h-screen py-16 justify-center relative">
                            ...
                            <div className="lg:w-5/12 flex flex-col gap-8 ">
                                <div
                                    ...
                                    <img
                                        className="absolute bottom-0 mirror-y right-[-14%] h-[24vh]"
                                        src="./4/bear-side.png"
                                    />
                                    <iframe
                                        className="w-full h-full"
                                        src="https://dexscreener.com/solana/CSUbFtooSRsNs1HfAreVnG42fwef234gD6AUZ3Mt6deYtAcv3uQjp?embed=1&theme=dark"></iframe>
                                </div>
                            </div>
                        </div>
                    </AppearWrapper>
